...
<s:form id="form1" namespace="/admin" action="editMenu" theme="simple" method="get">
		...
		<tr>
			<td height="32" background="../images/title_bg.gif">
				...
				<tr>
					...
					<td width="270" class="title_01">메뉴수정 </td>
			...
			<td><table width="750" border="0" cellpadding="0" cellspacing="1" class="MSlinetd">
				...
				<tr>
					...
					<td width="230" class="MS06td" style="padding-left:5px">
						<input type="text" name="menu_id" value="${menu_id}" class="m_box" style="width:150" readOnly />
					</td>
					...
					<td width="300" class="MS06td" style="padding-left:5px">
						<input type="text" name="menu_nm" value="${menu_nm}" class="box" style="width:150" />
					</td>
				</tr>
				<tr>
					...
					<td colspan="3" class="MS07td" style="padding-left:5px">
						<input type="text" name="menu_path" value="${menu_path}" class="box" style="width:500" />
					</td>
				</tr>
				<tr>
