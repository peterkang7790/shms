...
<script type="text/javascript">
	function saveAccess() {
		if (document.form1.user_id.value != "") {
			listAccess.method = "post";
			listAccess.target = "_self";
			listAccess.action = "saveAccess.do";
			listAccess.submit();
		} else {
...
<s:form id="form1" namespace="/admin" action="listAccess" theme="simple" method="get">
			...
			<table width="750" border="0" cellspacing="0" cellpadding="0">
					...
					<td width="270" height="10">
						...
						<tr>
							<td width="12" valign="middle">
								<img src="../images/point_title_02.gif" width="5" height="13" align="absmiddle"/>
							</td>
						...
						<tr>
							<td width="270" height="10">
								...
								<tr>
									...
									<td width="248" class="title_02">메뉴별 접근권한 </td>
								</tr>
								</table>
							</td>
							<td style="padding:10px 0px 0px 130px;">
								<a href="javascript:saveAccess();">
									<img src="../images/btn_save.gif" border="0">
								</a>
				...
				<tr>
					<td valign="top">
						...
						<s:iterator value="rsListAccessUser" status="stat">
						...
						<tr>
							...
							<td align="center" class="<%=bg%>">
								...
								<s:else><s:a href="listAccess.do?user_id=%{user_id}"><s:property value="user_id" /></s:a>
								</s:else>
							</td>
							<td align="center" class="<%=bg%>">
								<s:if test="user_nm==null">&nbsp;</s:if>
								<s:else><s:a href="listAccess.do?user_id=%{user_id}"><s:property value="user_nm" /></s:a>
								</s:else>
							</td>
						</tr>
						</s:iterator>
					...
					<td valign="top">
						...
						<s:iterator value="rsListAccessMenu" status="stat">
						...
						<tr>
							...
							<td align="left" class="<%=bg%>"> &nbsp;
								...
								<s:else>
									<s:if test="p_menu_id != null"> &nbsp;&nbsp; - &nbsp; </s:if>
									<s:property value="menu_nm" />
								</s:else>
							</td>
							<td align="center" class="<%=bg%>">
								<s:if test='sel_yn == "Y"'>
									<s:checkbox name="access_yn" id="access_yn" fieldValue="%{access_yn + ',' + menu_id}" value="%{access_yn}" />
								</s:if>
							</td>
						</tr>
