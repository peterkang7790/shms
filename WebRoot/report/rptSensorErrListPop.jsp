...
<s:push value="rsRptSensorErrList" >
<s:form id="form1" namespace="/report" action="rptSensorErrListPop" theme="simple" method="get">
...
<tr>
	<td valign="top">
		...
		<tr>
			<td height="32" colspan="2" background="../images/popup_img_bg.gif">
				...
				<tr>
					...
					<td width="270" class="popup_title" style="padding-top:4px">장애조치내역 </td>
		...
		<tr>
			...
			<tr>
				<td width="110" height="22" class="MS05td" style="padding-left:5px"><div align="left">장애ID</div></td>
				<td width="250" class="MS06td" style="padding-left:5px">
					<s:if test="err_id==null">&nbsp;</s:if><s:else><s:property value="err_id" /></s:else>
				</td>
			...
			<tr>
				<td height="22" class="MS05td" style="padding-left:5px"><div align="left">센서종류</div></td>
				<td class="MS06td" style="padding-left:5px">
					<s:if test="sensor_type_nm==null">&nbsp;</s:if><s:else><s:property value="sensor_type_nm" /></s:else>
				</td>
				<td height="22" class="MS05td" style="padding-left:5px"><div align="left">발생일시</div></td>
				<td class="MS06td" style="padding-left:5px">
					<s:if test="prod_dt==null">&nbsp;</s:if><s:else><s:property value="prod_dt" /></s:else>
				</td>
			</tr>
			<tr>
				<td height="22" class="MS05td" style="padding-left:5px"><div align="left">장애구분</div></td>
				<td class="MS06td" style="padding-left:5px">
					<s:if test="err_type_nm==null">&nbsp;</s:if><s:else><s:property value="err_type_nm" /></s:else>
				</td>
			...
			<tr>
				<td height="22" class="MS05td" style="padding-left:5px"><div align="left">조치일</div></td>
