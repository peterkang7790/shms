...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="1" background="../../images/bg.gif" >
<tr>
      <td height="10"></td>
</tr>
<tr>
		...
		<tr>
			<td colspan="2" height="32" background="../images/title_bg.gif">
				...
				<tr>
					...
					<td width="250" class="title_01">구조물 현황 </td>
					<td width="470" class="route"><div align="right"></div></td>
				</tr>
				</table>
			</td>
		</tr>
				...
				<table width="500" border="0" cellspacing="1" cellpadding="2">
					...
					<tr>
						<td class="MS07td">
							...
							<div align="center">
								<img name="img" src="../upload/<s:if test='image_path==null'>none.gif</s:if><s:else><s:property value='image_path' /></s:else>" />
							</div>
							</s:iterator>
						</td>
					</tr>
					              ...
					              <table width="270" height="25" border="0" cellpadding="0" cellspacing="1" class="MS0linetd">
					                <tr>
					                  ...
					                  <td width="200" height="25" class="MS06td" style="padding-left:10px">
						                  <img src="../images/sensor_P_01.gif" width="8" height="8" border="0">&nbsp;변형율계 &nbsp; 
						                  <img src="../images/sensor_P_02.gif" width="8" height="8" border="0">&nbsp;각도계 &nbsp; 
						                  <img src="../images/sensor_P_03.gif" width="8" height="8" border="0">&nbsp;온도계
					                  </td>
					                </tr>
					              </table>
				              </td>
						...
						<td align="center" class="<%=bg%>">
							...
							<s:else> 
								<s:if test="trouble_act_y_count>0">
									...
									<s:a href="javascript:MM_openBrWindow('troubleCancel.do?sensor_id=%{sensor_id}','','width=810,height=450,resizable=yes,scrollbars=yes');" onfocus="this.blur();">
										<img src="../images/help.bmp" border="0" style="cursor:hand;" align="absmiddle"/>
									</s:a>
								</s:if>
								<s:else>
