...
<frameset  rows="*,22" frameborder="no" border="0" framespacing="0">
	<frameset rows="114,*" cols="*" frameborder="no" border="0" framespacing="0">
		...
		<frameset cols="200,*" frameborder="no" border="0" framespacing="0">
			<frame src="<%=RootPath%>common/leftMenu.do?num=2000" name="leftFrame" scrolling="No" noresize="noresize" id="leftFrame" title="leftFrame" />
			<frame src="<%=RootPath%>common/mainView.do" name="mainFrame" id="mainFrame" title="mainFrame" scrolling="auto"/>
		</frameset>
	</frameset>
