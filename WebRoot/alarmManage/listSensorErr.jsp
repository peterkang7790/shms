...
<s:form id="form1" namespace="/alarmManage" action="listSensorErr" theme="simple" method="get">
		...
		<tr>
			<td colspan="2">
				...
				<tr>
					...
					<td align="left" class="<%=bg%>"><s:if test="sensor_id==null">&nbsp;</s:if><s:else><s:property value="sensor_id" /></s:else></td>
					...
					<s:if test="#session.USED_CLASS_CD==1">
						<td align="center" class="<%=bg%>" style="padding-left:5px">
							<s:if test='marking_yn == "N"'> 
									<s:a href="editSensorErr.do?err_id=%{err_id}&sensor_id=%{p_sensor}&nowPage=%{reqMap.nowPage}&err_type_cd=%{p_errtype}&marking_yn=%{p_markingyn}" onfocus="this.blur();">
