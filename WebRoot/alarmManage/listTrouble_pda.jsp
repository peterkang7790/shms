...
<s:form id="form1" namespace="/alarmManage" action="listTroublePda" theme="simple" method="get">
			...
			<td colspan="2">
				...
				<tr>
					...
					<td align="center" class="<%=bg%>" style="padding-left:5px">
						<s:a href="detailTrouble.do?trouble_id=%{trouble_id}&pda=pda" onfocus="this.blur();"><img src="../images/btnS_view0.gif" width="32" height="17" border="0" align="absmiddle"></s:a>
						...
						<a href="javascript:MM_openBrWindow('editViewTrouble.do?trouble_id=<s:property value="trouble_id" />','','width=760,height=350,resizable=yes');" onfocus="this.blur();">
							<img src="../images/btnS_action.gif" width="32" height="17" border="0" align="absmiddle">
						</a>
						</s:if>
					</td>
				</tr>
