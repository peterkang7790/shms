...
<script type="text/javascript">
	...
	var xmlChartBottom = "<trendlines><line startValue='8' color='ff0000' displayValue='high' showOnTop='1'/><line startValue='-8' color='ff00006' displayValue='low' showOnTop='1'/></trendlines></graph>";
...
//			jQuery("#rsSensor_sensor_loc").html((tmp_sensor_x_loc=="null"?"":"X:"+tmp_sensor_x_loc)+(tmp_sensor_y_loc=="null"?"":" , Y:"+tmp_sensor_y_loc));
	...
	*/
	function setGraphSetHeader()
	{
		...
		xmlChartHeader = "<graph caption='"+ tmp_sensor_type_nm +"' subcaption='["+ subCap +"]' baseFont='굴림' baseFontSize = '11' " 
	...
	*/
	function setGraphSetBottom()
	{
    	...
    	{
    		vLine = "<line startValue='"+ tmp_base_value +"' thickness='2' color='#757575' displayValue='영점값' showOnTop='1'/>";
    	}

		xmlChartBottom = " <trendlines> "
						 + " <line startValue='"+ tmp_h_cri_lmt +"' thickness='1' color='#FF0000' displayValue='위험' showOnTop='1'/>"
						 + " <line startValue='"+ tmp_h_maj_lmt +"' thickness='1' color='#FF9900' displayValue='경고' showOnTop='1'/>"
						 + " <line startValue='"+ tmp_l_cri_lmt +"' thickness='1' color='#FF0000' displayValue='위험' showOnTop='1'/>"
						 + " <line startValue='"+ tmp_l_maj_lmt +"' thickness='1' color='#FF9900' displayValue='경고' showOnTop='1'/>"
						 + vLine
						 + " </trendlines></graph>";
	}
</script>
	...
	<td valign="top">
		...
		<tr>
			<td colspan="2" height="32" background="../images/title_bg.gif">
				...
				<tr>
					...
					<td width="270" class="title_01">실시간계측현황 </td>
		...
		<tr>
			...
			<td width="240" valign="top" align="right">
				<table width="238" height="16" border="0" cellpadding="0" cellspacing="0" style="padding:10px 0px 0px 1px;">
				<tr>
					<td width="12" valign="middle"><img src="../images/point_title_02.gif" width="5" height="13"></td>
		...
		<tr>
			<td valign="top">
				...
				<tr>
					<td class="MS07td">
						...
						<div align="center">
							<img name="img" src="../upload/<s:if test='image_path==null'>none.gif</s:if><s:else><s:property value='image_path' /></s:else>" width="500" height="300" style="cursor:crosshair;" />
						</div>
						</s:iterator>
					</td>
				</tr>
					              ...
					              <table width="270" height="27" border="0" cellpadding="0" cellspacing="1" class="MS0linetd">
					                <tr>
					                  ...
					                  <td width="200" height="27" class="MS06td" style="padding-left:10px">
						                  <img src="../images/sensor_P_01.gif" width="7" height="7" border="0">&nbsp;변형율계 &nbsp; 
						                  <img src="../images/sensor_P_02.gif" width="7" height="7" border="0">&nbsp;각도계 &nbsp; 
						                  <img src="../images/sensor_P_03.gif" width="7" height="7" border="0">&nbsp;온도계
					                  </td>
					                </tr>
					              </table>
				              </td>
			...
			<td valign="top" align="right" style="padding:5px 0px 0px 1px;">
			<div id="rsSensor" >
				<table width="240" border="0" cellpadding="0" cellspacing="1" class="MSlinetd" >
					<tr>
						<td width="90" height="25" class="MS05td" style="padding-left:10px"><div align="left">센서ID</div></td>
						<td width="140" height="25" class="MS06td" style="padding-left:5px" id="rsSensor_sensor_id"></td>
					</tr>
					<tr>
					...
					<table height="26" border="0" cellpadding="0" cellspacing="1" class="mainText" width="240">
				    	<tr>
		...
		<s:else>
			<s:if test='sensor_type_cd=="1"'>
				<s:if test="trouble_class_cd!=null">
					...
					<s:if test='trouble_class_cd=="2"'><% icon = "sensor_O_01.gif"; %></s:if>
				</s:if>
				<s:else>
			...
			<s:elseif test='sensor_type_cd=="2"'>
				...
				<s:if test="trouble_class_cd!=null">
					...
					<s:if test='trouble_class_cd=="2"'><% icon = "sensor_O_02.gif"; %></s:if>
				</s:if>
				<s:else>
					<% icon = "sensor_G_02.gif"; %>
				</s:else>
			...
			<s:if test='sensor_type_cd=="3"'>
				<s:if test="trouble_class_cd!=null">
					...
					<s:if test='trouble_class_cd=="2"'><% icon = "sensor_O_03.gif"; %></s:if>
				</s:if>
				<s:else>
