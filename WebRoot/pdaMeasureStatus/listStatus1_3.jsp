...
<div id="content">
	...
	<table width="235" border="0" cellspacing="1" cellpadding="0" class="treeTable"> 
	  <tr >
	    <td style="background-color:#82add9;"><a href="listStat1_2.jsp" ><b>보강형</b></a></td>
	  </tr>	
	  <tr id="menu1">
	    <td style="background-color:#cbdef2;"><a href="#" onClick="return toggleMenu('menu1_1')">&nbsp;&nbsp;&nbsp;경사변위</a></td>
	  </tr>
	  <tr id="menu1_1">
	    <td style="background-color:#edf4fb;"><a href="detailStatGrap.jsp">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;변형률계</a></td>
	  </tr>
	   <tr id="menu1_1">
	    <td style="background-color:#edf4fb;"><a href="detailStatGrap.jsp">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;온도계</a></td>
	  </tr>
	   <tr id="menu1_1">
	    <td style="background-color:#edf4fb;"><a href="detailStatGrap.jsp">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;신축 이음계</a></td>
	  </tr>
