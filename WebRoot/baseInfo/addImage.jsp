...
<style type="text/css">
<!--
body { margin-left: 10px; margin-top: 10px; margin-right: 0px; margin-bottom: 0px;}rr
...
<tr>
	<td valign="top">
		...
		<tr>
			<td height="32" background="<%=ImgPath%>title_bg.gif">
				<table width="740" border="0" cellspacing="0" cellpadding="0" style="padding:0px 0px 0px 5px;">
					...
					<td width="450" class="route"><div align="right">홈&nbsp;&gt;&nbsp;기준정보&nbsp;&gt;&nbsp;이미지등록</div></td>
					</tr>
				</table>
			</td>
		</tr>
		...
		<tr>
			<td  height="30" class="MS05td" style="padding-left:10px"><div align="left">이미지구분</div>
			</td>
			<td class="MS07td" style="padding-left:5px">
		...
		<tr>	
			<td height="60" class="MS05td" style="padding-left:10px"><div align="left">실제사이즈</div>
			</td>
			<td class="MS06td" style="padding-left:5px">
		...
		<tr>	
			<td height="60" class="MS05td" style="padding-left:10px"><div align="left">표시사이즈</div>
			</td>
			<td class="MS07td" style="padding-left:5px">
