...
<s:hidden name="image_type" value="%{image_type}" />
	...
	<td valign="top">
		...
		<tr>
			<td height="32" background="<%=ImgPath%>title_bg.gif">
				...
				<tr>
					...
					<td width="450" class="route"><div align="right">홈&nbsp;&gt;&nbsp;기준정보&nbsp;&gt;&nbsp;이미지수정</div></td>
				</tr>
				</table>
			</td>
		</tr>
		<tr>
			<td height="57" valign="top">
				...
				<tr>
					...
					<td width="682" class="title_02">이미지수정</td>
				</tr>
				</table>
			</td>
		</tr>
		...
		<tr>
			...
			<td class="MS06td" style="padding-left:5px">
				<input type="text" name="image_id" class="m_box" value="${image_id}" readOnly/>
				<br>
		...
		<tr>	
			...
			<td class="MS07td" style="padding-left:5px">
				<input type="text" name="image_title" class="box" value="${image_title}" />
			</td>
		</tr>
		<tr>
			<td height="40" class="MS05td" style="padding-left:10px"><div align="left">파일</div></td>
			<td class="MS06td" style="padding-left:5px">
				<input type="text" name="image_name" class="graybox" value="${image_name}" readOnly/>
				<br/>
		...
		<tr>
			...
			<td class="MS07td" style="padding-left:5px">
				<s:select name="image_type_cd" id="image_type_cd" list="sensor_image_type_list" listKey="image_type_cd" listValue="sensor_image_type_nm" headerKey="" headerValue="--이미지구분선택--" ></s:select>
			</td>
		</tr>
		<tr>
		...
		<tr>	
			...
			<td class="MS06td" style="padding-left:5px">
				<input type="text" name="real_size" style="width:100" class="box" value="${real_size}"/> 
			</td>
		</tr>
		<tr>	
			...
			<td class="MS07td" style="padding-left:5px">
				<input type="text" name="disp_size" style="width:100" class="box" value="${disp_size}"/> 
			</td>
		</tr>
		</table>
...
<tr>
  	<td align="ceneter" colspan="2">
		...
		<tr>
			<td align="center">
				<s:hidden name="image_path" value="%{image_path}" />
